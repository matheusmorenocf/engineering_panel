...
export const DrawingCard = ({ drawingId, products, descriptions }: DrawingCardProps) => {
  return (
    <div className="bg-surface border border-border rounded-2xl p-6 hover:border-secondary/50 transition-all group flex flex-col shadow-sm">
      ...
      <button className="w-full py-3 bg-bg border border-border rounded-xl text-[10px] font-black uppercase tracking-widest text-text-tertiary hover:bg-secondary hover:text-white hover:border-secondary transition-all flex items-center justify-center gap-2">
        <Info size={14} />
        Detalhes do Grupo
      </button>
    </div>
